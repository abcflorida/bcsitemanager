...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'sitemanager');

		$('.daterangepicker_end_input').attr('data-grid', 'sitemanager');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('sitemanager', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
